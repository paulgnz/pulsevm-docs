/* ============================================================================
   SYNCED COPY for the standalone preview (atom-3d-preview.html), which loads
   it over HTTP with an import-mapped CDN three. The CANONICAL module lives at
   docs/.vitepress/theme/proton-atom-scene.js (bundled by Vite; Vite cannot
   import JS from public/). If you edit one, re-copy to the other.
   ============================================================================
